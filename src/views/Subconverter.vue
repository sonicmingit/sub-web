                            ...
                            <div v-if="advanced === '2'">
                                ...
                                <el-form-item label="远程配置:">
                                    ...
                                    >
                                        ...
                                        <el-button slot="append" @click="gotoRemoteConfig" icon="el-icon-link">配置示例
                                        </el-button>
                                    </el-select>
                                </el-form-item>
                                ...
                                <el-form-item label-width="0px">
                                    <el-row type="flex">
                                        ...
                                        <el-popover placement="bottom" v-model="form.extraset">
                                            ...
                                            <el-row>
                                                <el-checkbox v-model="form.udp" @change="needUdp = true"
                                                             label="启用 UDP"></el-checkbox>
                                            </el-row>
                                            <el-row>
...
<script>
    ...
    export default {
        ...
        methods: {
            // 获取yaml配置文件
            getConfigYaml() {
                axios.get("./../config.yaml", {headers: {"Cache-Control": "no-cache"}}).then((res) => {
                    var config = yaml.load(res.data);
                    // 后端地址
            ...
            // 获取json配置文件
            getConfigJson() {
                axios.get("./../config.json", {headers: {"Cache-Control": "no-cache"}}).then((res) => {
                    // 后端地址
                    this.options.backendOptions = res.data.backendOptions;
                    // 资源地址
                    this.options.remoteConfig = res.data.remoteConfig;
                }).catch((error) => {
                    console.log(error)
                });
            },
